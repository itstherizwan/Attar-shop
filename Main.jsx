        ...
        loading ? <Loader/> : <>
            ...
            <NavigationContainer ref={navigationRef} >
                ...
                <Stack.Navigator initialRouteName={isAuthenticated ? "home" : "login"}>
                    ...
                    <Stack.Screen name='successOrder' component={OrderSuccess} options={{ headerShown: false }}/>


                    {/* //Profile */}
                    <Stack.Screen name="profile" component={Profile} options={{ headerShown: false }} />

                    <Stack.Screen name="hot-featured" component={Loader} options={{ headerShown: false }} />

                    <Stack.Screen name="edit-profile" component={EditProfile} options={{ headerShown: false }} />

                    <Stack.Screen name="order" component={MyOrder} options={{ headerShown: false }} />
